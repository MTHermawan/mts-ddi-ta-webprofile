        ...
        <div class="nav-menu">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="<?php echo DOCUMENT_ROOT; ?>profile/sejarah.html">Sejarah</a>
                    <a href="<?php echo DOCUMENT_ROOT; ?>profile/struktur-organisasi.html">Struktur Organisasi</a>
                    <a href="<?php echo DOCUMENT_ROOT; ?>profile/guru.html">Guru</a>
                    <a href="<?php echo DOCUMENT_ROOT; ?>profile/fasilitas.html">Fasilitas Sekolah</a>
                    <a href="<?php echo DOCUMENT_ROOT; ?>profile/ekskul.html">Ekstrakurikuler Sekolah</a>
                </div>
            </div>

            <?php if (CURRENT_PAGE == 'inddex.html') { ?>
