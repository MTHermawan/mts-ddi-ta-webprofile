    ...
    <header>
        ...
        <section id="hero">
            <div class="hero-content">
                ...
                <h5>Sebagai lembaga pendidikan Islam, MTs DDI Tani Aman memiliki visi dan misi yang jelas untuk
                    membentuk siswa tidak hanya cerdas akademik, tetapi juga berakhlak mulia dan siap menghadapi
                    tantangan masa depan. Visi dan misi ini menjadi panduan dalam setiap proses pembelajaran dan
                    pengembangan karakter siswa.</h5>
            </div>
        </section>
    </header>
